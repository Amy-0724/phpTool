...
//		ben upd
	...
	public function xx(){
		...
		$this->assign ('check',$checks_value[$getmd]);
		/*var_dump($checks_value[$getmd]);
		var_dump($checks_value);
		exit;*/
		//$this->assign ('check',$checks_value);
		$this->display();
	}
...
//		var_dump($basal_adds);exit;
 ...
 public function get_access_token(){
    ...
    //    $param ['secret'] = $GLOBALS ['user'] ['secret'];
        $param ['appid'] = "wx081dff0c2d8258af";
        $param ['secret'] = "3ee9912895c6fa30c834005af662ca7f";
